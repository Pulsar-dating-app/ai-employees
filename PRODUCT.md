...
Customer-side interaction happens entirely inside WhatsApp, not in the Sidde product surface — the customer should perceive "someone from this store is helping me," never a bot or a Sidde-branded experience.
...
Malu herself — name, role, personality traits, behavioral rules, and example dialogue — is confirmed real product truth (see `Sidde_MVP_Specification.md`), not placeholder content.
