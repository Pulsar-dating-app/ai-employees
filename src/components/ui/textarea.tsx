  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <textarea
        ...
        rows={rows}
        className={clsx(
          "resize-y rounded-md border border-neutral-300 px-3 py-2 text-sm outline-none focus:border-accent-500 disabled:cursor-not-allowed disabled:bg-neutral-50 disabled:text-neutral-500",
